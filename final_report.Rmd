...
We also were looking to explore questions related to the day of the week, however we decided not to move forward with this analysis because there was a lot of missing data in the variables.
...
Although the data was pretty clean, it would’ve been nice if there were more continuous variables, especially for our regression models. 
