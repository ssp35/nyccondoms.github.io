...
Coding errors can sometimes feel like looking for a needle in a haystack. Throughout our project we did encounter some minor issues with code, inability to knit, and lack of knowledge in some areas of R that we incorporated in our analysis. Particularly, the intricacies of R Shiny. 
...
Based on our exploration of male vs. female condom availability, male condoms are much more readily available. There needs to be a greater distribution of female condoms in the city.

Overall, the most popular types of venues that distribute condoms were Community-Based Organizations/Non-Profits and Businesses. We found it really surprising that Sexual Health Clinics only have 2 distribution locations, and recommend that a greater number distribute free safer sex products.

Over 2/3 of the total number of venues were in Manhattan and Brooklyn alone. Considering that Queens has the second largest population of the boroughs, we found it surprising that only 17% of the venues were located there. We recommend the condom distribution program to increase its presence in Queens.
